...
<div class="page" v-if="!loading">
  <heroVideo :url="home.hero_video.embed_url" :thumbnail="home.hero_image" :body="home.hero_body" />
  <article class="home-title section">
    <div class="container">
      <div class="rich-text" v-html="$prismic.asHtml(home.description)" v-scroll-reveal="{scale: 1, distance: '200px', origin: 'bottom', delay: '500'}"></div>
    </div>
  </article>
  <!-- Repeatable Slices -->
